...
//    private lateinit var factory: GamePlayerTanksManager
//
//    @BeforeEach
//    fun beforeEach() {
//        game = mockGame()
...
//        factory = GamePlayerTanksManager(
//            game,
//            mock(),
//            spriteContainer,
...
//
//        verify(eventManager).fireEvent(isA<GamePlayerTanksManager.PlayerTankCreated>())
//    }
//
//    @Test
...
//
//        val captor = argumentCaptor<GamePlayerTanksManager.PlayerTankCreated>()
...
//        factory.notify(TankExplosion.Destroyed(explosion))
//
//        verify(eventManager, never()).fireEvent(isA<GamePlayerTanksManager.PlayerTankCreated>())
